...
INSERT INTO posts (id, title, content, subscription_id, creator_id, created_at, updated_at)
VALUES
    -- Посты для подписок на Антонио Пантера
    ('8a96163c-bbf5-4f69-bc9d-4eac93f98bb1', 'Добро пожаловать!', 'Добро пожаловать в мою базовую подписку!', '3d0a9b10-ba41-40ec-9751-b7c981814d8d', '778d7f25-f9b3-4367-9bf0-b58ebd2183e2', NOW(), NOW()),
    ('add8a649-1539-456e-a558-8fb2ad93be5c', 'Эксклюзивный контент', 'Здесь вы найдете эксклюзивные материалы.', '1e71d674-6da0-4cdc-8fda-f1baeb39dabc', '778d7f25-f9b3-4367-9bf0-b58ebd2183e2', NOW(), NOW()),
    ('9c2dd56c-3cb3-4f19-8f79-0f0a5cfb8c32', 'Важное объявление', 'Платиновый уровень подписки получает доступ к уникальным предложениям.', '89891479-891c-462c-8a31-9191896ca8e9', '778d7f25-f9b3-4367-9bf0-b58ebd2183e2', NOW(), NOW()),

    -- Посты для подписок на ПуЛи_От_БаБуЛи
    ('b527e3a1-7384-4327-8f66-24a46c0b7a16', 'Первые шаги', 'Спасибо за подписку на базовый уровень!', '28f2f790-9546-431d-9ded-bb3ce88c13d5', '6ffae18b-d844-42f6-9e5d-48732a34165c', NOW(), NOW()),
    ('75a3a7b2-1a94-42ed-8d80-2c2e9f148ae7', 'Продвинутые техники', 'Про подписка предоставляет доступ к продвинутым техникам.', '9480b299-e411-40e0-b362-c7c026f3cab5', '6ffae18b-d844-42f6-9e5d-48732a34165c', NOW(), NOW()),
    ('b872dcfb-676f-4a09-8df4-5db4bff28d4b', 'Секреты успеха', 'Платиновый уровень подписки раскрывает все секреты успеха.', 'be161cb5-5e22-4bfc-89a8-53863e35da89', '6ffae18b-d844-42f6-9e5d-48732a34165c', NOW(), NOW()),

    -- Посты для подписок на Серега21
    ('6e68d8f7-7c1e-4b21-bf95-c2a5dc0c1a2c', 'Начало пути', 'Базовая подписка Серега21: начнем с малого.', '279d3e74-dbaf-467f-ad81-9a9e173cae34', 'cab915c7-cbac-4dd9-9f00-8ded705b6fd2', NOW(), NOW()),
    ('02f93c57-f432-432e-8dc4-4c86b5d2ef8f', 'Серьезные занятия', 'Про подписка Серега21: серьезные занятия начинаются здесь.', 'f626c525-b55b-4872-892b-8c8b95ce963f', 'cab915c7-cbac-4dd9-9f00-8ded705b6fd2', NOW(), NOW()),
    ('b24842d7-3299-4a8b-a67c-818ca40ea1a0', 'Мастер-класс', 'Платиновая подписка Серега21: мастер-классы для вас.', 'bd0ff191-ee65-483d-9615-515b8cd3a6ed', 'cab915c7-cbac-4dd9-9f00-8ded705b6fd2', NOW(), NOW()),

    -- Дополнительные посты для подписок на Антонио Пантера
    ('2390c780-f4dc-4b41-bb4e-1cf9f5678b60', 'Новое видео', 'Посмотрите мое новое видео!', '3d0a9b10-ba41-40ec-9751-b7c981814d8d', '778d7f25-f9b3-4367-9bf0-b58ebd2183e2', NOW(), NOW()),
    ('d799601b-f589-4a90-b9b8-bc30e6c62761', 'Вопросы и ответы', 'Про подписка: задавайте ваши вопросы.', '1e71d674-6da0-4cdc-8fda-f1baeb39dabc', '778d7f25-f9b3-4367-9bf0-b58ebd2183e2', NOW(), NOW()),
    ('a74e5f3e-34b4-4c55-bb99-e2b8a63c3e4e', 'Эксклюзивные предложения', 'Платиновая подписка: только для вас!', '89891479-891c-462c-8a31-9191896ca8e9', '778d7f25-f9b3-4367-9bf0-b58ebd2183e2', NOW(), NOW()),

    -- Дополнительные посты для подписок на ПуЛи_От_БаБуЛи
    ('51c1d82d-30b0-4169-8e0d-c8a5db3b947f', 'Советы', 'Базовая подписка: мои советы для вас.', '28f2f790-9546-431d-9ded-bb3ce88c13d5', '6ffae18b-d844-42f6-9e5d-48732a34165c', NOW(), NOW()),
    ('617a19ed-25a5-4545-b82d-2c1b8a0048da', 'Тренировки', 'Про подписка: лучшие тренировки.', '9480b299-e411-40e0-b362-c7c026f3cab5', '6ffae18b-d844-42f6-9e5d-48732a34165c', NOW(), NOW()),
    ('f4c1236c-f37e-42c6-8eb2-e7c5f7119b2b', 'Интервью', 'Платиновая подписка: эксклюзивные интервью.', 'be161cb5-5e22-4bfc-89a8-53863e35da89', '6ffae18b-d844-42f6-9e5d-48732a34165c', NOW(), NOW()),

    -- Дополнительные посты для подписок на Серега21
    ('909d5f1e-9e12-47f5-bd7e-500cb939ed16', 'Инструкции', 'Базовая подписка: пошаговые инструкции.', '279d3e74-dbaf-467f-ad81-9a9e173cae34', 'cab915c7-cbac-4dd9-9f00-8ded705b6fd2', NOW(), NOW()),
    ('fa1284b4-6e82-42f4-b950-b1b7dcdcd58c', 'Секреты мастера', 'Про подписка: секреты от мастера.', 'f626c525-b55b-4872-892b-8c8b95ce963f', 'cab915c7-cbac-4dd9-9f00-8ded705b6fd2', NOW(), NOW()),
    ('5b96b8f5-bd62-414f-a6f7-e4db5e11534b', 'Эксклюзивные уроки', 'Платиновая подписка: эксклюзивные уроки.', 'bd0ff191-ee65-483d-9615-515b8cd3a6ed', 'cab915c7-cbac-4dd9-9f00-8ded705b6fd2', NOW(), NOW());
